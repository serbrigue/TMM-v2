...
import {
    PlayCircle, Users, DollarSign, Clock, CheckCircle,
...
const AdminCourseDetail = () => {
    ...
    useEffect(() => {
        const fetchCourse = async () => {
            try {
                ...
                const response = await axios.get(`http://localhost:8000/api/admin/cursos/${id}/`, {
    ...
    if (!course) return <div className="p-8 text-center text-red-500">Curso no encontrado</div>;
