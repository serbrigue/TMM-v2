...
const WorkshopDetail = () => {
    ...
    const checkEnrollment = async () => {
        try {
            ...
            const enrolled = response.data.talleres.some((t: any) => t.taller.id === parseInt(id!));
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-20">
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-brand-pink to-brand-calypso text-white py-20">
                            ...
                            <div className="flex items-center gap-4">
                                <button
                                    ...
                                    className={`px-8 py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-lg ${isEnrolled
                                        ...
                                        : 'bg-white text-brand-pink hover:bg-gray-50 shadow-white/30'
                                        }`}
                                >
                                    {isEnrolled
                                        ? '✓ Inscrito'
